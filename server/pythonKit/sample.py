...
paytmParams["MID"] = "playzi02115984898118"
paytmParams["ORDERID"] = "11"

# Generate checksum by parameters we have
# Find your Merchant Key in your Paytm Dashboard at https://dashboard.paytm.com/next/apikeys
paytmChecksum = PaytmChecksum.generateSignature(paytmParams, "sOTydda&s#wYtNQF")
verifyChecksum = PaytmChecksum.verifySignature(paytmParams, "sOTydda&s#wYtNQF",paytmChecksum)
